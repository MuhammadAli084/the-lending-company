...
const TypingText = () => {
  const fullMessageList = [
    ...
    ["No Hidden Charges.", "Just Smart Lending."],
    ["Grow Your Portfolio.", "Without Paying Us."],
    ["We Work for You.", "Not a Commission."],
    ["Rental Investment?", "We've Got You – Fee-Free."],
    ["Dedicated to Landlords.", "Not Charging Fees."],
    ["No Surprises.", "Just Transparent Lending."],
    ["Zero Broker Costs.", "100% Clarity."],
    ["More Profit to You.", "No Cut for Us."],
    ["Let Property, Not Fees.", "We Don’t Take a Penny."],
    ["Smart Buy-to-Let Advice.", "Without Hidden Fees."],
