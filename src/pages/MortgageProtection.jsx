...
const TypingText = () => {
  const fullMessageList = [
    ...
    ["Mortgage Protection.", "Peace of Mind for Your Family."],
    ["Safeguard Your Investment.", "With the Right Coverage."],
    ["Don't Leave it to Chance.", "Protect Your Mortgage Today."],
    ["Financial Security.", "For What Matters Most."],
    ["Your Family's Safety Net.", "Mortgage Protection Insurance."],
    ["Protect Your Biggest Asset.", "Your Home, Your Future."],
    ["Insurance You Can Depend On.", "For Life's Uncertainties."],
    ["Secure Your Mortgage.", "Protect Your Loved Ones."],
    ["Mortgage Protection Experts.", "Here to Help You."]
  ];
...
const MortgageProtection = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const API_URL = "http://localhost:3000/submit-mortgage-protection"; // Change the endpoint
  ...
  return (
    <>
        ...
        <div className="form-box">
          ...
          <form onSubmit={handleSubmit} className="styled-form">
            ...
            <div className="form-group">
              ...
              <input className="form-input" type="number" name="coverageAmount" value={formData.coverageAmount} onChange={handleChange} required />
            </div>
      ...
      <QualitySection
        ...
        description="Safeguard your most valuable asset with our tailored mortgage protection plans.  We offer a range of solutions designed to protect your family and investment, ensuring financial security no matter what the future holds.  Our expert advisors will help you find the right coverage to fit your needs and budget."
