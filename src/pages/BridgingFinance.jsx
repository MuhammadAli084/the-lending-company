...
const TypingText = () => {
  const fullMessageList = [
    ...
    ["Urgent Property Deals?", "We Don’t Charge Fees."],
    ["Bridging Loans, Fast.", "Fee-Free. Always."],
    ["Bridging Without Brokers.", "You Save More."],
    ["No Upfront Costs.", "No Broker Involved."],
    ["Auction Finance Experts.", "No Brokerage Fees."],
    ["Speed. Flexibility.", "100% Transparent."],
    ["Bridging Loans in Days.", "No Fees. No Fuss."],
    ["Flexible Lending.", "Without the Middleman."],
    ["Bridge Gaps Instantly.", "We Don’t Take a Cut."],
    ["Short-Term Loans.", "Zero Surprise Charges."],
    ["Bridge with Confidence.", "Pay Lender, Not Us."],
